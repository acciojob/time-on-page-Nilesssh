...
hidebtn.addEventListener("click", async () => {
  ...
  try {
    ...
    newDetails.insertAdjacentHTML(
      ...
      <div class="middle3 nana"><b>Pincode:    ${ipData.postal}</b></div>
      <div class="middle4 nana"><span><b>Message:    </b>Number of pincode(s) found:   ${filteredPostalData.length}</span></div>
      <div>
